"""
File: 	gaussmod_fit.py
Author:	Jack Fawdon 
Date:	2021-06-01
----------------------
This fits an exponentially modified gaussian function to a peak at 700 cm-1, take x at max height, and transforms to a concentration gradient. Initially used to visualise concentration gradient in ionic liquid electrolyte.
"""
